...
// * module ng HttpRequest =  est une requête HTTP sortante avec un corps typé facultatif, rend les instances "immmuables" (ne peuvent ête modifiées aprés création)
